...
def main():
    ...
    cartesian_kinematics_matrices, total_energy, pe_array, ke_array,total_energy_1d = kinematics_calculator(Pos_init, A_init, V_init, k, n, L0_l, L0_c, L0_e, M, time_interval, damping_constant)
    ...
    print(n)
    wave_prop_plot = ax1.imshow(np.transpose(total_energy_1d), aspect='auto', extent=[0, np.max(time_interval), 0, n-2], origin='lower')
    ...
    plt.savefig(folder_dir + '_waveprop_1d'+ date + '.png')
